...
writeRaster(L2_mask, "~/Documents/DTU/6. Semester/Bachelorprojekt/Data_Ellen_Maria/LandcoverMap/Extract_masks/Level2_mask.tif", overwrite = TRUE)

#### Test plot ####
rm(list=ls())
library(raster)
setwd("~/Documents/DTU/6. Semester/Bachelorprojekt/Data_Ellen_Maria/LandcoverMap/Extract_masks")
Level2 <- raster("Level2_mask.tif")
...
plot(Level2, main = "Visualisation of Level 2: Agricultural areas")
dev.off()
